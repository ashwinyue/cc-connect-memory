...
var messages = map[MsgKey]map[Language]string{
	...
	MsgIdentityNotConfigured: {
		...
		LangChinese:            "人格系统未配置。",
		LangTraditionalChinese: "人格系統未配置。",
		LangJapanese:           "アイデンティティシステムが設定されていません。",
		LangSpanish:            "El sistema de identidad no está configurado.",
	},
	MsgIdentityEmpty: {
		LangEnglish:            "No identity file found. Use `/identity edit` to create one.",
		LangChinese:            "未找到身份文件。使用 `/identity edit` 创建。",
		LangTraditionalChinese: "未找到身份檔案。使用 `/identity edit` 建立。",
		LangJapanese:           "アイデンティティファイルが見つかりません。`/identity edit` で作成してください。",
		LangSpanish:            "No se encontró archivo de identidad. Use `/identity edit` para crear uno.",
	},
	MsgIdentityEditUsage: {
		LangEnglish:            "Usage: `/identity edit <content>`",
		LangChinese:            "用法：`/identity edit <内容>`",
		LangTraditionalChinese: "用法：`/identity edit <內容>`",
		LangJapanese:           "使い方: `/identity edit <内容>`",
		LangSpanish:            "Uso: `/identity edit <contenido>`",
	},
	MsgIdentitySaveFailed: {
		LangEnglish:            "Failed to save identity: %v",
		LangChinese:            "保存身份失败: %v",
		LangTraditionalChinese: "儲存身分失敗: %v",
		LangJapanese:           "アイデンティティの保存に失敗しました: %v",
		LangSpanish:            "Error al guardar identidad: %v",
	},
	MsgIdentitySaved: {
		LangEnglish:            "✅ Identity saved.",
		LangChinese:            "✅ 身份已保存。",
		LangTraditionalChinese: "✅ 身分已儲存。",
		LangJapanese:           "✅ アイデンティティを保存しました。",
		LangSpanish:            "✅ Identidad guardada.",
	},
	MsgSoulEmpty: {
		LangEnglish:            "No soul file found. Use `/identity soul edit` to create one.",
		LangChinese:            "未找到灵魂文件。使用 `/identity soul edit` 创建。",
		LangTraditionalChinese: "未找到靈魂檔案。使用 `/identity soul edit` 建立。",
		LangJapanese:           "ソウルファイルが見つかりません。`/identity soul edit` で作成してください。",
		LangSpanish:            "No se encontró archivo de alma. Use `/identity soul edit` para crear uno.",
	},
	MsgSoulEditUsage: {
		LangEnglish:            "Usage: `/identity soul edit <content>`",
		LangChinese:            "用法：`/identity soul edit <内容>`",
		LangTraditionalChinese: "用法：`/identity soul edit <內容>`",
		LangJapanese:           "使い方: `/identity soul edit <内容>`",
		LangSpanish:            "Uso: `/identity soul edit <contenido>`",
	},
	MsgSoulSaveFailed: {
		LangEnglish:            "Failed to save soul: %v",
		LangChinese:            "保存灵魂失败: %v",
		LangTraditionalChinese: "儲存靈魂失敗: %v",
		LangJapanese:           "ソウルの保存に失敗しました: %v",
		LangSpanish:            "Error al guardar alma: %v",
	},
	MsgSoulSaved: {
		LangEnglish:            "✅ Soul saved.",
		LangChinese:            "✅ 灵魂已保存。",
		LangTraditionalChinese: "✅ 靈魂已儲存。",
		LangJapanese:           "✅ ソウルを保存しました。",
		LangSpanish:            "✅ Alma guardada.",
	},
	// Profile system
	MsgProfileNotConfigured: {
		LangEnglish:            "Profile system is not configured.",
		LangChinese:            "用户资料系统未配置。",
		LangTraditionalChinese: "用戶資料系統未配置。",
		LangJapanese:           "プロフィールシステムが設定されていません。",
		LangSpanish:            "El sistema de perfiles no está configurado.",
	},
	MsgProfileEmpty: {
		LangEnglish:            "No profiles found. Use `/profile add` to create one.",
		LangChinese:            "未找到用户资料。使用 `/profile add` 创建。",
		LangTraditionalChinese: "未找到用戶資料。使用 `/profile add` 建立。",
		LangJapanese:           "プロフィールが見つかりません。`/profile add` で作成してください。",
		LangSpanish:            "No se encontraron perfiles. Use `/profile add` para crear uno.",
	},
	MsgProfileNotFound: {
		LangEnglish:            "Profile not found.",
		LangChinese:            "未找到用户资料。",
		LangTraditionalChinese: "未找到用戶資料。",
		LangJapanese:           "プロフィールが見つかりません。",
		LangSpanish:            "Perfil no encontrado.",
	},
	MsgProfileAlreadyExists: {
		LangEnglish:            "Profile already exists: %s",
		LangChinese:            "用户资料已存在: %s",
		LangTraditionalChinese: "用戶資料已存在: %s",
		LangJapanese:           "プロフィールは既に存在します: %s",
		LangSpanish:            "El perfil ya existe: %s",
	},
	MsgProfileAddUsage: {
		...
		LangSpanish:            "Uso: `/profile add <id> <atributo:valor>...`",
	},
	MsgProfileAddFailed: {
		LangEnglish:            "Failed to add profile: %v",
		LangChinese:            "添加用户资料失败: %v",
		LangTraditionalChinese: "新增用戶資料失敗: %v",
		LangJapanese:           "プロフィールの追加に失敗しました: %v",
		LangSpanish:            "Error al agregar perfil: %v",
	},
	MsgProfileAdded: {
		LangEnglish:            "✅ Profile added: %s",
		LangChinese:            "✅ 用户资料已添加: %s",
		LangTraditionalChinese: "✅ 用戶資料已新增: %s",
		LangJapanese:           "✅ プロフィールを追加しました: %s",
		LangSpanish:            "✅ Perfil agregado: %s",
	},
	MsgProfileEditUsage: {
		...
		LangSpanish:            "Uso: `/profile edit <id> <atributo:valor>...`",
	},
	MsgProfileEditFailed: {
		LangEnglish:            "Failed to update profile: %v",
		LangChinese:            "更新用户资料失败: %v",
		LangTraditionalChinese: "更新用戶資料失敗: %v",
		LangJapanese:           "プロフィールの更新に失敗しました: %v",
		LangSpanish:            "Error al actualizar perfil: %v",
	},
	MsgProfileUpdated: {
		LangEnglish:            "✅ Profile updated: %s",
		LangChinese:            "✅ 用户资料已更新: %s",
		LangTraditionalChinese: "✅ 用戶資料已更新: %s",
		LangJapanese:           "✅ プロフィールを更新しました: %s",
		LangSpanish:            "✅ Perfil actualizado: %s",
	},
	...
	MsgProfileDeleteFailed: {
		...
		LangChinese:            "删除用户资料失败: %v",
		LangTraditionalChinese: "刪除用戶資料失敗: %v",
		LangJapanese:           "プロフィールの削除に失敗しました: %v",
		LangSpanish:            "Error al eliminar perfil: %v",
	},
	MsgProfileDeleted: {
		LangEnglish:            "✅ Profile deleted: %s",
		LangChinese:            "✅ 用户资料已删除: %s",
		LangTraditionalChinese: "✅ 用戶資料已刪除: %s",
		LangJapanese:           "✅ プロフィールを削除しました: %s",
		LangSpanish:            "✅ Perfil eliminado: %s",
	},
