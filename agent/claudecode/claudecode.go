...
func New(opts map[string]any) (core.Agent, error) {
	...
	if dataDir == "" {
		dataDir = workDir // fallback to workDir if dataDir not set
	}
...
func (a *Agent) StartSession(ctx context.Context, sessionID string) (core.AgentSession, error) {
	...
	return newClaudeSession(ctx, a.workDir, a.dataDir, model, sessionID, a.mode, tools, extraEnv, platformPrompt)
}
